...
mouth_cascade = cv2.CascadeClassifier('haar_features/haarcascade_mcs_mouth.xml')
nose_cascade = cv2.CascadeClassifier('haar_features/haarcascade_mcs_nose.xml')
leftEar_cascade = cv2.CascadeClassifier('haar_features/haarcascade_mcs_leftear.xml')
rightEar_cascade = cv2.CascadeClassifier('haar_features/haarcascade_mcs_rightear.xml')
